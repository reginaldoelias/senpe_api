        ...
        return http
                ...
                .authorizeHttpRequests(authorize->
                        authorize.requestMatchers(HttpMethod.GET,"/users/lists/**").hasRole("ADMIN")
                                ...
                                .requestMatchers(HttpMethod.POST,"/users/reauthenticate").permitAll()
                                .requestMatchers(HttpMethod.POST,"/users/validar").permitAll()
                                .requestMatchers(HttpMethod.POST,"/users/app/qrcode").permitAll()
                                .requestMatchers(HttpMethod.POST,"/users/reset-password").permitAll()
                                .requestMatchers(HttpMethod.POST,"/users/oath/setup").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET,"/solicitacao/{tipo}/**").hasAnyRole(Perfil.ADMINISTRADOR.name(), Perfil.OPERADOR.name())
                                .requestMatchers(HttpMethod.POST,"/solicitacao/update").permitAll()
                                .requestMatchers(HttpMethod.GET,"/solicitacao/requests").hasAnyRole(Perfil.ADMINISTRADOR.name(), Perfil.OPERADOR.name())
                                .requestMatchers(HttpMethod.GET,"/solicitacao/operator/**").hasAnyRole(Perfil.ADMINISTRADOR.name(), Perfil.OPERADOR.name())
                                .requestMatchers(HttpMethod.POST,"/solicitacao/resultado").hasAnyRole(Perfil.ADMINISTRADOR.name(), Perfil.OPERADOR.name())
                                .requestMatchers(HttpMethod.GET,"/solicitacao/filter").hasAnyRole(Perfil.ADMINISTRADOR.name(), Perfil.OPERADOR.name())
                                .requestMatchers(HttpMethod.PUT,"/solicitacao/change/**").hasAnyRole(Perfil.ADMINISTRADOR.name(), Perfil.OPERADOR.name())
                                .requestMatchers(HttpMethod.GET,"/solicitacao/**").hasAnyRole(Perfil.ADMINISTRADOR.name(), Perfil.OPERADOR.name())
                                .requestMatchers(HttpMethod.POST,"/solicitacao/schedule/**").hasAnyRole(Perfil.ADMINISTRADOR.name(), Perfil.OPERADOR.name())
                                .requestMatchers(HttpMethod.PUT,"/solicitacao/schedule/cancel/**").permitAll()
                                .requestMatchers(HttpMethod.GET,"/solicitacao/search").hasAnyRole(Perfil.ADMINISTRADOR.name(), Perfil.OPERADOR.name())
